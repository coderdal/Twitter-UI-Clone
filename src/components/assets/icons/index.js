const TwitterIcon = ({ color }) => {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" fill={color || "#fff"}>
      <g>
...
const WorldIcon = ({ color }) => {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" fill={color || "#1a8cd8"}>
      <g>
...
const ReplyIcon = ({ color }) => {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" fill={color || "#8b98a5"}>
      <g>
